...
public class FileTypeResolver implements Serializable {
     ...
     */
    private static Resource DEFAULT_ICON = VaadinIcons.FILE_O;
...
//            return icon;
//        }
    	if (mimeType.contains("font")) return VaadinIcons.FILE_FONT;
    	if (mimeType.contains("html")) return VaadinIcons.FILE_CODE;
    	if (mimeType.contains("css")) return VaadinIcons.FILE_CODE;
    	if (mimeType.contains("java")) return VaadinIcons.FILE_CODE;
    	if (mimeType.contains("c++")) return VaadinIcons.FILE_CODE;
    	if (mimeType.contains("excel")) return VaadinIcons.FILE_TABLE;
    	if (mimeType.contains("word")) return VaadinIcons.FILE_TEXT_O;
    	if (mimeType.contains("powerpoint")) return VaadinIcons.FILE_PRESENTATION;
    	if (mimeType.contains("zip")) return VaadinIcons.FILE_ZIP;
    	if (mimeType.contains("pdf")) return VaadinIcons.FILE_TEXT_O;
    	if (mimeType.startsWith("audio")) return VaadinIcons.FILE_SOUND;
